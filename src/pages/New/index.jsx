// Importando o useState para armazenar os estados
...
export function New() {
    ...
    async function handleNewNote() {
        if (!title) {
            return alert("Digite o títtulo da nota.");
        }
        ...
        if (newLink) {
            ...
            return alert("Coloque pelo menos um link.");
        }
        ...
        if (tags.length <= 0) {
            return ("Coloque pelo menos uma tag.");
        }
